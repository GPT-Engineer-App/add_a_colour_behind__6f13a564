            ...
            <Tr>
              ...
              {players.map((player, playerIndex) => (
                <Td key={playerIndex} isNumeric>
                  <Input type="number" value={player.scores[currentHole] === 0 ? "" : player.scores[currentHole]} onChange={(e) => handleScoreChange(playerIndex, currentHole, e.target.value)} size="sm" max={9} min={0} bg={currentHole === playerIndex ? "yellow.100" : "transparent"} color={currentHole === playerIndex ? "black" : "gray.500"} fontStyle={currentHole === playerIndex ? "normal" : "italic"} />
                </Td>
              ))}
            </Tr>
            <Tr>
